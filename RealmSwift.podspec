...
Pod::Spec.new do |s|
  ...
  s.source                  = spec.source  = { :https://raw.githubusercontent.com/adamtruemotion/precompiled/main/RealmSwift.framework.zip }
  ...
  s.platform = :ios, "11.0"
  s.swift_version = "5.3"
  s.vendored_frameworks = "RealmSwift.framework"
end